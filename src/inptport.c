...
struct ipd inputport_defaults[] =
{
  ...
  { IPT_START1,   "P1 시작",      SEQ_DEF_3(KEYCODE_1, CODE_OR, JOYCODE_1_START) },
  { IPT_START2,   "P2 시작",      SEQ_DEF_3(KEYCODE_2, CODE_OR, JOYCODE_2_START) },
  { IPT_START3,   "P3 시작",      SEQ_DEF_3(KEYCODE_3, CODE_OR, JOYCODE_3_START) },
  { IPT_START4,   "P4 시작",      SEQ_DEF_3(KEYCODE_4, CODE_OR, JOYCODE_4_START) },
  ...
  { IPT_COIN1,    "P1 동전",       SEQ_DEF_3(KEYCODE_5, CODE_OR, JOYCODE_1_SELECT) },
  { IPT_COIN2,    "P2 동전",       SEQ_DEF_3(KEYCODE_6, CODE_OR, JOYCODE_2_SELECT) },
  { IPT_COIN3,    "P3 동전",       SEQ_DEF_3(KEYCODE_7, CODE_OR, JOYCODE_3_SELECT) },
  { IPT_COIN4,    "P4 동전",       SEQ_DEF_3(KEYCODE_8, CODE_OR, JOYCODE_4_SELECT) },
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER1, "P1 위",          SEQ_DEF_5(KEYCODE_UP,       CODE_OR, JOYCODE_1_UP,          CODE_OR, JOYCODE_1_LEFT_UP)       },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER1, "P1 아래",        SEQ_DEF_5(KEYCODE_DOWN,     CODE_OR, JOYCODE_1_DOWN,        CODE_OR, JOYCODE_1_LEFT_DOWN)     },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER1, "P1 왼쪽",        SEQ_DEF_5(KEYCODE_LEFT,     CODE_OR, JOYCODE_1_LEFT,        CODE_OR, JOYCODE_1_LEFT_LEFT)     },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER1, "P1 오른쪽",       SEQ_DEF_5(KEYCODE_RIGHT,    CODE_OR, JOYCODE_1_RIGHT,       CODE_OR, JOYCODE_1_LEFT_RIGHT)    },
  { IPT_BUTTON1             | IPF_PLAYER1, "P1 버튼 1",      SEQ_DEF_5(KEYCODE_LCONTROL, CODE_OR, JOYCODE_1_BUTTON1,     CODE_OR, JOYCODE_MOUSE_1_BUTTON1) },
  { IPT_BUTTON2             | IPF_PLAYER1, "P1 버튼 2",      SEQ_DEF_5(KEYCODE_LALT,     CODE_OR, JOYCODE_1_BUTTON2,     CODE_OR, JOYCODE_MOUSE_1_BUTTON2) },
  { IPT_BUTTON3             | IPF_PLAYER1, "P1 버튼 3",      SEQ_DEF_5(KEYCODE_SPACE,    CODE_OR, JOYCODE_1_BUTTON3,     CODE_OR, JOYCODE_MOUSE_1_BUTTON3) },
  { IPT_BUTTON4             | IPF_PLAYER1, "P1 버튼 4",      SEQ_DEF_3(KEYCODE_LSHIFT,   CODE_OR, JOYCODE_1_BUTTON4)  },
  ...
  { IPT_JOYSTICK_UP         | IPF_PLAYER2, "P2 위",           SEQ_DEF_5(KEYCODE_R,             CODE_OR, JOYCODE_2_UP,         CODE_OR, JOYCODE_2_LEFT_UP)       },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER2, "P2 아래",         SEQ_DEF_5(KEYCODE_F,             CODE_OR, JOYCODE_2_DOWN,       CODE_OR, JOYCODE_2_LEFT_DOWN)     },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER2, "P2 왼쪽",         SEQ_DEF_5(KEYCODE_D,             CODE_OR, JOYCODE_2_LEFT,       CODE_OR, JOYCODE_2_LEFT_LEFT)     },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER2, "P2 오른쪽",       SEQ_DEF_5(KEYCODE_G,             CODE_OR, JOYCODE_2_RIGHT,      CODE_OR, JOYCODE_2_LEFT_RIGHT)    },
  { IPT_BUTTON1             | IPF_PLAYER2, "P2 버튼 1",       SEQ_DEF_5(KEYCODE_A,             CODE_OR, JOYCODE_2_BUTTON1,    CODE_OR, JOYCODE_MOUSE_2_BUTTON1) },
  { IPT_BUTTON2             | IPF_PLAYER2, "P2 버튼 2",       SEQ_DEF_5(KEYCODE_S,             CODE_OR, JOYCODE_2_BUTTON2,    CODE_OR, JOYCODE_MOUSE_2_BUTTON2) },
  { IPT_BUTTON3             | IPF_PLAYER2, "P2 버튼 3",       SEQ_DEF_5(KEYCODE_Q,             CODE_OR, JOYCODE_2_BUTTON3,    CODE_OR, JOYCODE_MOUSE_2_BUTTON3) },
  { IPT_BUTTON4             | IPF_PLAYER2, "P2 버튼 4",       SEQ_DEF_3(KEYCODE_W,             CODE_OR, JOYCODE_2_BUTTON4) },
  ...
  { IPT_BUTTON4             | IPF_PLAYER3, "P3 버튼 4",       SEQ_DEF_1(JOYCODE_3_BUTTON4)  },
  { IPT_BUTTON5             | IPF_PLAYER3, "P3 버튼 5",       SEQ_DEF_1(JOYCODE_3_BUTTON5)  },
  { IPT_BUTTON6             | IPF_PLAYER3, "P3 버튼 6",       SEQ_DEF_1(JOYCODE_3_BUTTON6)  },
  { IPT_BUTTON7             | IPF_PLAYER3, "P3 버튼 7",       SEQ_DEF_1(JOYCODE_3_BUTTON7)  },
  { IPT_BUTTON8             | IPF_PLAYER3, "P3 버튼 8",       SEQ_DEF_1(JOYCODE_3_BUTTON8)  },
  { IPT_BUTTON9             | IPF_PLAYER3, "P3 버튼 9",       SEQ_DEF_1(JOYCODE_3_BUTTON9)  },
  { IPT_BUTTON10            | IPF_PLAYER3, "P3 버튼 10",      SEQ_DEF_1(JOYCODE_3_BUTTON10) },
  { IPT_JOYSTICKRIGHT_UP    | IPF_PLAYER3, "P3 오른쪽/위",    SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_DOWN  | IPF_PLAYER3, "P3 오른쪽/아래",  SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_LEFT  | IPF_PLAYER3, "P3 오른쪽/왼쪽",  SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_RIGHT | IPF_PLAYER3, "P3 오른쪽/오른쪽", SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER3, "P3 왼쪽/위",      SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER3, "P3 왼쪽/아래",    SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER3, "P3 왼쪽/왼쪽",    SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER3, "P3 왼쪽/오른쪽",  SEQ_DEF_0 },

  { IPT_JOYSTICK_UP         | IPF_PLAYER4, "P4 위",           SEQ_DEF_3(JOYCODE_4_UP,          CODE_OR, JOYCODE_4_LEFT_UP)       },
  { IPT_JOYSTICK_DOWN       | IPF_PLAYER4, "P4 아래",         SEQ_DEF_3(JOYCODE_4_DOWN,        CODE_OR, JOYCODE_4_LEFT_DOWN)     },
  { IPT_JOYSTICK_LEFT       | IPF_PLAYER4, "P4 왼쪽",         SEQ_DEF_3(JOYCODE_4_LEFT,        CODE_OR, JOYCODE_4_LEFT_LEFT)     },
  { IPT_JOYSTICK_RIGHT      | IPF_PLAYER4, "P4 오른쪽",       SEQ_DEF_3(JOYCODE_4_RIGHT,       CODE_OR, JOYCODE_4_LEFT_RIGHT)    },
  { IPT_BUTTON1             | IPF_PLAYER4, "P4 버튼 1",       SEQ_DEF_3(JOYCODE_4_BUTTON1,     CODE_OR, JOYCODE_MOUSE_4_BUTTON1) },
  { IPT_BUTTON2             | IPF_PLAYER4, "P4 버튼 2",       SEQ_DEF_3(JOYCODE_4_BUTTON2,     CODE_OR, JOYCODE_MOUSE_4_BUTTON2) },
  { IPT_BUTTON3             | IPF_PLAYER4, "P4 버튼 3",       SEQ_DEF_3(JOYCODE_4_BUTTON3,     CODE_OR, JOYCODE_MOUSE_4_BUTTON3) },
  { IPT_BUTTON4             | IPF_PLAYER4, "P4 버튼 4",       SEQ_DEF_1(JOYCODE_4_BUTTON4)  },
  { IPT_BUTTON5             | IPF_PLAYER4, "P4 버튼 5",       SEQ_DEF_1(JOYCODE_4_BUTTON5)  },
  { IPT_BUTTON6             | IPF_PLAYER4, "P4 버튼 6",       SEQ_DEF_1(JOYCODE_4_BUTTON6)  },
  { IPT_BUTTON7             | IPF_PLAYER4, "P4 버튼 7",       SEQ_DEF_1(JOYCODE_4_BUTTON7)  },
  { IPT_BUTTON8             | IPF_PLAYER4, "P4 버튼 8",       SEQ_DEF_1(JOYCODE_4_BUTTON8)  },
  { IPT_BUTTON9             | IPF_PLAYER4, "P4 버튼 9",       SEQ_DEF_1(JOYCODE_4_BUTTON9)  },
  { IPT_BUTTON10            | IPF_PLAYER4, "P4 버튼 10",      SEQ_DEF_1(JOYCODE_4_BUTTON10) },
  { IPT_JOYSTICKRIGHT_UP    | IPF_PLAYER4, "P4 오른쪽/위",    SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_DOWN  | IPF_PLAYER4, "P4 오른쪽/아래",  SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_LEFT  | IPF_PLAYER4, "P4 오른쪽/왼쪽",  SEQ_DEF_0 },
  { IPT_JOYSTICKRIGHT_RIGHT | IPF_PLAYER4, "P4 오른쪽/오른쪽", SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_UP     | IPF_PLAYER4, "P4 왼쪽/위",      SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_DOWN   | IPF_PLAYER4, "P4 왼쪽/아래",    SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_LEFT   | IPF_PLAYER4, "P4 왼쪽/왼쪽",    SEQ_DEF_0 },
  { IPT_JOYSTICKLEFT_RIGHT  | IPF_PLAYER4, "P4 왼쪽/오른쪽",  SEQ_DEF_0 },
...
struct ik input_keywords[] =
{
	...
	{ "UI_CHEAT",				IKT_IPT,		IPT_UI_CHEAT }, // Show_CHEATLIST_START
	{ "UI_COMMAND",				IKT_IPT,		IPT_UI_COMMAND}, //CMD_PLUS
#ifdef AUTO_FIRE 
    { "UI_TOGGLE_AUTOFIRE",		IKT_IPT,		IPT_UI_TOGGLE_AUTOFIRE },
#endif //AUTO_FIRE	
