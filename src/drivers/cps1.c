...
ROM_START( sf2 )
	...
	ROMX_LOAD( "sf2_25.bin", 0x400000, 0x80000, CRC(29256CF9) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2gfx21.rom */
	ROMX_LOAD( "sf2_27.bin", 0x400002, 0x80000, CRC(2B692A95) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2gfx23.rom */
	ROMX_LOAD( "sf2_24.bin", 0x400004, 0x80000, CRC(76294232) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2gfx20.rom */
	ROMX_LOAD( "sf2_26.bin", 0x400006, 0x80000, CRC(02E96DFF) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2gfx22.rom */
...
ROM_START( sf2ce )
	...
	ROMX_LOAD( "s92_10.bin",   0x400000, 0x80000, CRC(26681174) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "s92_11.bin",   0x400002, 0x80000, CRC(D6914A2E) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2.11 */
	ROMX_LOAD( "s92_12.bin",   0x400004, 0x80000, CRC(937F9560) , ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2.12 */
	ROMX_LOAD( "s92_13.bin",   0x400006, 0x80000, CRC(1C27F11E) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( wofk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "tk2k23c.bin",  0x000000, 0x80000, CRC(78A63855) )
	ROM_LOAD16_WORD_SWAP( "tk2k22c.bin",  0x080000, 0x80000, CRC(13DCCD83) )
	...
	ROMX_LOAD( "tk2_gfx2.rom",   0x000004, 0x80000, CRC(c5ca2460) SHA1(cbe14867f7b94b638ca80db7c8e0c60881183469) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk2_gfx4.rom",   0x000006, 0x80000, CRC(e349551c) SHA1(1d977bdf256accf750ad9930ec4a0a19bbf86964) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk205k.bin",      0x200000, 0x80000, CRC(188BE08A) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk206k.bin",      0x200002, 0x80000, CRC(3A02B86B) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk207k.bin",      0x200004, 0x80000, CRC(22D0F9FD) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "tk208k.bin",      0x200006, 0x80000, CRC(AA00FE36) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( area88rk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "araj_23k.8f", 0x00000, 0x80000, CRC(3BC63457) )
	ROM_LOAD16_WORD_SWAP( "araj_22k.7f", 0x80000, 0x80000, CRC(91FF2031) )

	ROM_REGION( 0x200000, REGION_GFX1, 0 )
	ROMX_LOAD( "ara_01k.3a",   0x000000, 0x80000, CRC(EAFF9AD0) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_02k.4a",   0x000002, 0x80000, CRC(23CB00F8) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_03k.5a",   0x000004, 0x80000, CRC(561FCAAF) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_04k.6a",   0x000006, 0x80000, CRC(294DC71F) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( area88rka )
	...
	ROM_REGION( 0x200000, REGION_GFX1, 0 )
	ROMX_LOAD( "ara_01ka.3a",   0x000000, 0x80000, CRC(3D3C50FC) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_02ka.4a",   0x000002, 0x80000, CRC(693BB1F1) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_03ka.5a",   0x000004, 0x80000, CRC(BB3443D3) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ara_04ka.6a",   0x000006, 0x80000, CRC(DB3353FA) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( captcomjk )
	...
	ROM_LOAD16_BYTE( "ccj_24fk.9e",        0x100000, 0x20000, CRC(6856B740))
	ROM_LOAD16_BYTE( "ccj_28fk.9f",        0x100001, 0x20000, CRC(B5EC9706))
...
ROM_START( kodjk )
	...
	ROM_LOAD16_BYTE( "kdj_37a.11f",  0x00001, 0x20000, CRC(1CB9A149) )
	ROM_LOAD16_BYTE( "kdj_31a.12e",  0x40000, 0x20000, CRC(622DD533) )   // == kde_31a.12e
	ROM_LOAD16_BYTE( "kdj_38a.12f",  0x40001, 0x20000, CRC(4CB36B59) )   // == kde_38a.12f
	ROM_LOAD16_WORD_SWAP("kd_33.6f", 0x80000, 0x80000, CRC(260F5607) )   // incorrect label, could be kdj_33a, kdj_33, kd_33a
	...
	ROMX_LOAD( "kod01.rom",    0x000004, 0x80000, CRC(5f74bf78) SHA1(b7c43eea9bf77a0fb571dcd53f8be719e6655fd9) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "kod03.rom",    0x000006, 0x80000, CRC(5e5303bf) SHA1(d9f90b898ffdf4398b2bbeb48247f06f728e7c00) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "kd_15.8c",  0x200000, 0x80000, CRC(2CD36C2A) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "kd_17.10c", 0x200002, 0x80000, CRC(BEE4E3AB) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "kd_14.7c",  0x200004, 0x80000, CRC(A31352DD) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "kd_16.9c",  0x200006, 0x80000, CRC(C64A44A0) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( daimakaik )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
	ROM_LOAD16_BYTE( "dmj_38k.12f", 0x00000, 0x20000, CRC(C970BABE) )
	ROM_LOAD16_BYTE( "dmj_39k.12h", 0x00001, 0x20000, CRC(5441A3E1) )
	ROM_LOAD16_BYTE( "dmj_40k.13f", 0x40000, 0x20000, CRC(0D559369) )
	ROM_LOAD16_BYTE( "dmj_41k.13h", 0x40001, 0x20000, CRC(9A5EAE6F) )
	...
	ROM_REGION( 0x300000, REGION_GFX1, 0 )
	ROMX_LOAD( "dm_02k.4b",  0x000000, 0x20000, CRC(9B7A9E4D) , ROM_SKIP(7) ) // == dm-05.3a
	ROMX_LOAD( "dm_01k.4a",  0x000001, 0x20000, CRC(EBC2DFB2) , ROM_SKIP(7) ) // == dm-05.3a
	ROMX_LOAD( "dm_10k.9b",  0x000002, 0x20000, CRC(B8DAFC20) , ROM_SKIP(7) ) // == dm-07.3f
	ROMX_LOAD( "dm_09k.9a",  0x000003, 0x20000, CRC(B3F98A6A) , ROM_SKIP(7) ) // == dm-07.3f
	ROMX_LOAD( "dm_18k.5e",  0x000004, 0x20000, CRC(0A42999C) , ROM_SKIP(7) ) // == dm-06.3c
	ROMX_LOAD( "dm_17k.5c",  0x000005, 0x20000, CRC(B7256B2C) , ROM_SKIP(7) ) // == dm-06.3c
	ROMX_LOAD( "dm_30k.8h",  0x000006, 0x20000, CRC(A3EEDD72) , ROM_SKIP(7) ) // == dm-08.3g
	ROMX_LOAD( "dm_29k.8f",  0x000007, 0x20000, CRC(3399A259) , ROM_SKIP(7) ) // == dm-08.3g
	...
	ROMX_LOAD( "dm_06k.7b",  0x200000, 0x10000, CRC(A156A133) , ROM_SKIP(7) ) // == 09.4a
	ROMX_LOAD( "dm_05k.7a",  0x200001, 0x10000, CRC(AF5235C1) , ROM_SKIP(7) ) // == 18.7a
	ROMX_LOAD( "dm_14k.11b", 0x200002, 0x10000, CRC(973EECE6) , ROM_SKIP(7) ) // == 13.4e
	ROMX_LOAD( "dm_13k.11a", 0x200003, 0x10000, CRC(03824BC9) , ROM_SKIP(7) ) // == 22.7e
	ROMX_LOAD( "dm_22k.8e",  0x200004, 0x10000, CRC(7C0EA715) , ROM_SKIP(7) ) // == 11.4c
	ROMX_LOAD( "dm_21k.8c",  0x200005, 0x10000, CRC(D3C0CA93) , ROM_SKIP(7) ) // == 20.7c
	ROMX_LOAD( "dm_26k.10e", 0x200006, 0x10000, CRC(2379A091) , ROM_SKIP(7) ) // == 15.4g
	ROMX_LOAD( "dm_25k.10c", 0x200007, 0x10000, CRC(2EC40B73) , ROM_SKIP(7) ) // == 24.7g
...
/* ROM_LOAD64_BYTE  -> ROMX_LOAD , ROM_SKIP(7)  */

ROM_START( striderjrk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sthj_23k.8f",   0x00000, 0x080000, CRC(75BBE661) )
	ROM_LOAD16_WORD_SWAP( "sthj_22.7f",   0x80000, 0x80000, CRC(9b3cfc08) SHA1(a7d7f270a097437affa845d80bed82a1fa874878) )

	ROM_REGION( 0x400000, REGION_GFX1, 0 )
	ROMX_LOAD( "sth_01k.3a",    0x000000, 0x80000, CRC(04C36C00) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_02k.4a",    0x000002, 0x80000, CRC(C4EE13E0) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_03k.5a",    0x000004, 0x80000, CRC(96D36CB7) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_04k.6a",    0x000006, 0x80000, CRC(808E37B7) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_05k.7a",    0x200000, 0x80000, CRC(678C7875) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_06k.8a",    0x200002, 0x80000, CRC(4955A2BA) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_07k.9a",    0x200004, 0x80000, CRC(49B558B4) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sth_08k.10a",   0x200006, 0x80000, CRC(04F93716) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( ffightaek )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "ff-23mk.8h", 0x00000, 0x80000, CRC(5FEF82DD) )
	ROM_LOAD16_WORD_SWAP( "ff-22m.7h", 0x80000, 0x80000, CRC(CBDD8689) SHA1(a75918ee837dfccdd4fd02b716928a2de2003103) )
	
	ROM_REGION( 0x200000, REGION_GFX1, 0 )
	ROMX_LOAD( "ff-5mk.7a", 0x000000, 0x80000, CRC(99781F70) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ff-7mk.9a", 0x000002, 0x80000, CRC(898726D4) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ff-1mk.3a", 0x000004, 0x80000, CRC(DD9785CE) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ff-3mk.5a", 0x000006, 0x80000, CRC(0C1C90A6) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( ffightjk )
	...
	ROM_LOAD16_BYTE( "ff37k.bin",  	 0x40000, 0x20000, CRC(7F277E22) )
	ROM_LOAD16_BYTE( "ff43k.bin",    0x40001, 0x20000, CRC(2E0C3BF7) )
	...
	ROMX_LOAD( "ffjk_10.5b",    0x100000, 0x20000, CRC(AEF14517) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_02.5a",    0x100001, 0x20000, CRC(AF04AFF3) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_14.10b",   0x100002, 0x20000, CRC(401628BE) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_06.10a",   0x100003, 0x20000, CRC(A70601F2) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_25.7e",    0x100004, 0x20000, CRC(A23A56B7) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_18.7c",    0x100005, 0x20000, CRC(430B873E) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_39.9h",    0x100006, 0x20000, CRC(DE2E0DC8) , ROM_SKIP(7) )
	ROMX_LOAD( "ffjk_33.9f",    0x100007, 0x20000, CRC(C8770BB7) , ROM_SKIP(7) )
