...
static WRITE_HANDLER(cop_up_fct_w)
{
	cop_buf[offset] = data;
	if(offset == 3) {
...
static WRITE_HANDLER(cop_up_adr_w)
{
	if(offset)
...
static WRITE_HANDLER(cop_up_data_w)
{
	if(offset)
...
static WRITE_HANDLER(cop_reg_w)
{
...
static WRITE_HANDLER(cop_fct_w)
{
	if(offset) {
...
static WRITE_HANDLER(sprcpt_adr_w)
{
	combine32(&sprcpt_adr, offset, data);
}

static WRITE_HANDLER(sprcpt_data_1_w)
{
	combine32(sprcpt_data_1+sprcpt_adr, offset, data);
}

static WRITE_HANDLER(sprcpt_data_2_w)
{
	combine32(sprcpt_data_2+sprcpt_adr, offset, data);
}

static WRITE_HANDLER(sprcpt_data_3_w)
{
...
static WRITE_HANDLER(sprcpt_data_4_w)
{
...
static WRITE_HANDLER(sprcpt_val_1_w)
{
	combine32(sprcpt_val+0, offset, data);
}

static WRITE_HANDLER(sprcpt_val_2_w)
{
	combine32(sprcpt_val+1, offset, data);
}

static WRITE_HANDLER(sprcpt_flags_1_w)
{
...
static WRITE_HANDLER(sprcpt_flags_2_w)
{
...
static MEMORY_WRITE_START( raiden2_writemem )
    { 0x00432, 0x00433, cop_up_data_w},
	{ 0x00434, 0x00435, cop_up_adr_w},
	{ 0x00438, 0x0043d, cop_up_fct_w},
	{ 0x004a0, 0x004df, cop_reg_w},
	{ 0x00500, 0x00501, cop_fct_w},
	{ 0x006a0, 0x006a3, sprcpt_val_1_w},
	{ 0x006a4, 0x006a7, sprcpt_data_3_w},
	{ 0x006a8, 0x006ab, sprcpt_data_4_w},
	{ 0x006ac, 0x006af, sprcpt_flags_1_w},
	{ 0x006b0, 0x006b3, sprcpt_data_1_w},
	{ 0x006b4, 0x006b7, sprcpt_data_2_w},
	{ 0x006b8, 0x006bb, sprcpt_val_2_w},
	{ 0x006bc, 0x006bf, sprcpt_adr_w},
	{ 0x006ce, 0x006cf, sprcpt_flags_2_w},
	{ 0x00000, 0x0bfff, any_w},
...
static DRIVER_INIT (r2nocpu)
{
	...
	cpu_set_irq_line(0, INPUT_LINE_RESET, ASSERT_LINE);
