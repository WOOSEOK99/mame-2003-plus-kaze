...
static MEMORY_WRITE16_START( dead_cps2_writemem )
	{ 0x000000, 0x3fffff, MWA16_ROM },				/* ROM */
	{ 0x400000, 0x40000b, MWA16_RAM, &cps2_output, &cps2_output_size },	/* CPS2 output */
	{ 0x618000, 0x619fff, qsound_sharedram1_w },		/* Q RAM */
	{ 0x662000, 0x662001, MWA16_RAM },				/* Network adapter related, accessed in SSF2TB */
	...
	{ 0x804100, 0x8041ff, cps1_output_w, &cps1_output, &cps1_output_size },  /* Output ports */
	{ 0x900000, 0x92ffff, cps1_gfxram_w, &cps1_gfxram, &cps1_gfxram_size },
	{ 0xff0000, 0xffffef, MWA16_RAM },				/* RAM */
	{ 0xfffff0, 0xfffffb, MWA16_RAM, &cps2_output, &cps2_output_size},				/* RAM */
	{ 0xfffffc, 0xffffff, MWA16_RAM },				/* RAM */
MEMORY_END
...
static MACHINE_DRIVER_START( dead_cps2 )
	...
	MDRV_CPU_ADD(M68000, 11800000)
	MDRV_CPU_CONFIG(cps2_encryption)
	MDRV_CPU_MEMORY(cps2_readmem,dead_cps2_writemem)
	MDRV_CPU_VBLANK_INT(cps2_interrupt,262)	/* 262   // ??? interrupts per frame /*/
...
/*	MDRV_INTERLEAVE(262)   // 262 scanlines, for raster effects /*/
	...
	MDRV_VIDEO_ATTRIBUTES(VIDEO_TYPE_RASTER | VIDEO_NEEDS_6BITS_PER_GUN | VIDEO_UPDATE_BEFORE_VBLANK)
	MDRV_SCREEN_SIZE(64*8, 32*8)
	//MDRV_VISIBLE_AREA(8*8, (64-8)*8-1, 4*8, 30*8-1 )
	MDRV_VISIBLE_AREA(130, 508, 28, 255 )
...
<<<<<<< HEAD
	...
	ROM_LOAD16_WORD_SWAP( "sfz3mix.06",   0x180000, 0x80000, CRC(35639da3) )
	ROM_LOAD16_WORD_SWAP( "sfz3mix.07",   0x200000, 0x80000, CRC(a9d9f83e) )
...
>>>>>>> 7268b4800bc1d7a47ba44483043167f3f45d77b5
	...
	ROM_REGION( 0x2000000, REGION_GFX1, 0 )
	ROMX_LOAD( "sfz3mix.13m",   0x0000000, 0x400000, CRC(93183516) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.15m",   0x0000002, 0x400000, CRC(B06F14CE) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.17m",   0x0000004, 0x400000, CRC(661C1355) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.19m",   0x0000006, 0x400000, CRC(7227F353) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.14m",   0x1000000, 0x400000, CRC(62496779) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.16m",   0x1000002, 0x400000, CRC(1E7AA3CB) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfz3mix.18m",   0x1000004, 0x400000, CRC(95E161CE) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( hsf2a )
	...
	ROM_REGION( 0x2000000, REGION_GFX1, 0 )
	ROMX_LOAD( "hs2.13m",   0x0000000, 0x800000, CRC(E5354D35) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.15m",   0x0000002, 0x800000, CRC(E7CBECCD) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.17m",   0x0000004, 0x800000, CRC(9CFFD92C) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.19m",   0x0000006, 0x800000, CRC(D0CE2D5D) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( ssf2 )
	...
	ROMX_LOAD( "ssf.14",   0x800000, 0x100000, CRC(A8969F30) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ssf.16",   0x800002, 0x100000, CRC(FA22CDC3) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ssf.18",   0x800004, 0x100000, CRC(8FB84DF0) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "ssf.20",   0x800006, 0x100000, CRC(F1651CE6) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( ddsomak )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "dd2k.03g", 0x000000, 0x80000, CRC(20A53ECB) )
	ROM_LOAD16_WORD_SWAP( "dd2k.04g", 0x080000, 0x80000, CRC(E2FC9C29) )
	ROM_LOAD16_WORD_SWAP( "dd2.05g",  0x100000, 0x80000, CRC(5eb1991c) SHA1(429a60b5396ff4192904867fbe0524268f0edbcb) )
	ROM_LOAD16_WORD_SWAP( "dd2k.06g",  0x180000, 0x80000, CRC(14C46332))
	ROM_LOAD16_WORD_SWAP( "dd2k.07",   0x200000, 0x80000, CRC(9C6706D7))
	ROM_LOAD16_WORD_SWAP( "dd2.08",   0x280000, 0x80000, CRC(e53c4d01) SHA1(bad872e4e793a39f68bc0e580772e982714b5876) )
	ROM_LOAD16_WORD_SWAP( "dd2k.09",   0x300000, 0x80000, CRC(09AC4B22) )
	ROM_LOAD16_WORD_SWAP( "dd2.10",   0x380000, 0x80000, CRC(ad954c26) SHA1(468c01735dbdb1114b37060546a660678290a97f) )
	...
	ROM_REGION( 0x1800000, REGION_GFX1, 0 )
	ROMX_LOAD( "dd2k.13",   0x0000000, 0x400000, CRC(651786DD) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "dd2k.15",   0x0000002, 0x400000, CRC(173CE940) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "dd2k.17",   0x0000004, 0x400000, CRC(C18C9B32) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "dd2k.19",   0x0000006, 0x400000, CRC(0436A109) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( ddsomjk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "dd2jk.03g", 0x000000, 0x80000, CRC(CE684DD4) )
	ROM_LOAD16_WORD_SWAP( "dd2jk.04g", 0x080000, 0x80000, CRC(64212C8D) )
	ROM_LOAD16_WORD_SWAP( "dd2.05g",  0x100000, 0x80000, CRC(5eb1991c) SHA1(429a60b5396ff4192904867fbe0524268f0edbcb) )
	ROM_LOAD16_WORD_SWAP( "dd2k.06g",  0x180000, 0x80000, CRC(14C46332) )
	ROM_LOAD16_WORD_SWAP( "dd2k.07",   0x200000, 0x80000, CRC(9C6706D7) )
	ROM_LOAD16_WORD_SWAP( "dd2.08",   0x280000, 0x80000, CRC(e53c4d01) SHA1(bad872e4e793a39f68bc0e580772e982714b5876) )
...
ROM_START( sfzjk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sfzjk.03c", 0x000000, 0x80000, CRC(FF9F72CC) )
	ROM_LOAD16_WORD_SWAP( "sfz.04b",  0x080000, 0x80000, CRC(8b73b0e5) SHA1(5318761f615c21395366b5333e75eaaa73ef2073) )
	ROM_LOAD16_WORD_SWAP( "sfz.05a",  0x100000, 0x80000, CRC(0810544d) SHA1(5f39bda3e7b16508eb58e5a2e0cc58c09cf428ce) )
	ROM_LOAD16_WORD_SWAP( "sfz.06",   0x180000, 0x80000, CRC(806e8f38) )
	...
	ROM_REGION( 0x1000000, REGION_GFX1, 0 )
	ROM_FILL(              0x000000, 0x800000, 0 )
	ROMX_LOAD( "sfzk.14m",  0x800000, 0x200000, CRC(2ABED9AF) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfzk.16m",  0x800002, 0x200000, CRC(E30C4E37) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfzk.18m",  0x800004, 0x200000, CRC(A5A760B9) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sfzk.20m",  0x800006, 0x200000, CRC(C72B7C2D) , ROM_GROUPWORD | ROM_SKIP(6) )
...
// ROM_START( sfz2jk )
// 	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
// 	ROM_LOAD16_WORD_SWAP( "sz2jk.03b", 0x000000, 0x80000, CRC(E46526A9) )
// 	ROM_LOAD16_WORD_SWAP( "sz2jk.04b", 0x080000, 0x80000, CRC(5F8F5BC3) )
...
// 	ROM_LOAD16_WORD_SWAP( "sz2jk.07b", 0x200000, 0x80000, CRC(515CEB77) )
...
// 	ROM_REGION( 0x1400000, REGION_GFX1, 0 )
// 	ROMX_LOAD( "sz2k.13m",   0x0000000, 0x400000, CRC(10EF2D2B) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2k.15m",   0x0000002, 0x400000, CRC(FCC1F004) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2k.17m",   0x0000004, 0x400000, CRC(E364B775) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2k.19m",   0x0000006, 0x400000, CRC(EA68B6A9) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2.14",   0x1000000, 0x100000, CRC(0560c6aa) SHA1(f2bed3a8efef18052b51a7f0f6a888a18db813a1) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2.16",   0x1000002, 0x100000, CRC(ae940f87) SHA1(39ee26333abbe302ba76dced0196a2e6b3b1d02a) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2.18",   0x1000004, 0x100000, CRC(4bc3c8bc) SHA1(6256963c515bf56f39b6e559afefd653ead56c54) , ROM_GROUPWORD | ROM_SKIP(6) )
// 	ROMX_LOAD( "sz2.20",   0x1000006, 0x100000, CRC(39e674c0) SHA1(8e771a2d8c2accad0463bccd21d7b23af0c895a1) , ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( sfz2jr1k )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sz2jk.03a", 0x000000, 0x80000, CRC(671306BD) )
	ROM_LOAD16_WORD_SWAP( "sz2jk.04a", 0x080000, 0x80000, CRC(13CC798B) )
	ROM_LOAD16_WORD_SWAP( "sz2.05",   0x100000, 0x80000, CRC(98e8e992) SHA1(41745b63e6b3888081d189b8315ed3b7526b3d20) )
	ROM_LOAD16_WORD_SWAP( "sz2.06",   0x180000, 0x80000, CRC(5b1d49c0) SHA1(f0a0c894c9cbe2b18e7f59058665949ee0025732) )
	ROM_LOAD16_WORD_SWAP( "sz2jk.07a", 0x200000, 0x80000, CRC(213368E7) )
	ROM_LOAD16_WORD_SWAP( "sz2.08",   0x280000, 0x80000, CRC(0fe8585d) SHA1(0cd5369a5aa90c98d8dc1ff3342cd4d990631cff) )
...
ROM_START( sfz2aljk )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "szajk.03a", 0x000000, 0x80000, CRC(3C545A2A) )
	ROM_LOAD16_WORD_SWAP( "szajk.04a", 0x080000, 0x80000, CRC(9559AF19) )
	ROM_LOAD16_WORD_SWAP( "szajk.05a", 0x100000, 0x80000, CRC(D2CB29FA) )
	ROM_LOAD16_WORD_SWAP( "szaj.06a", 0x180000, 0x80000, CRC(35ed5b7a) SHA1(b03cb92f594eb35fa374445f74930e9040a2baff) )
	ROM_LOAD16_WORD_SWAP( "szaj.07a", 0x200000, 0x80000, CRC(975dcb3e) SHA1(a2ca8e5a768e49cce9e2137ec0dcba9337ed2ad5) )
	ROM_LOAD16_WORD_SWAP( "szaj.08a", 0x280000, 0x80000, CRC(dc73f2d7) SHA1(09fa10e7d1ff5f0dac87a6cf3d66730e3ab9ad25) )
